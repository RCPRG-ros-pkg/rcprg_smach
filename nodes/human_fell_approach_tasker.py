...
import smach
from smach_ros2 import IntrospectionServer
from geometry_msgs.msg import Pose
from tf_transformations import quaternion_from_euler, euler_from_quaternion
import math

# Import your custom modules here, you may need to adjust them for ROS2.
...
from tasker_msgs.srv import SuspendConditions
from tasker_msgs.srv import CostConditions
...
def ptf_csp(ptf_id):
    print(f"calculating SP: {ptf_id}")
    global human_name
    print(f"CSP -> human_name: {human_name}")
    global base_frame
    human_posture = rclpy.get_param("/"+human_name+"/actor_posture", "stand")
