...
class MyTaskER(TaskER):
    def __init__(self,da_state_name, da_name):
        ...
        self.my_fsm = rcprg_smach.bring_goods_tasker.BringGoods(self.sim_mode, self.conversation_interface, self.kb_places)
    ...
    def update_task_tf(self):
        ...
        print "SWAPPING"
        self.swap_state('ExecFSM', rcprg_smach.bring_goods_tasker.BringGoods(self.sim_mode, self.conversation_interface, self.kb_places))
        self.sis.start()
