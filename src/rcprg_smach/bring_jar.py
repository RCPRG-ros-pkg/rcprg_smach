...
class SetBaseDestination(smach_rcprg.State):
...
class BringJar(smach_rcprg.StateMachine):
    def __init__(self, sim_mode, conversation_interface, kb_places):
        smach_rcprg.StateMachine.__init__(self, input_keys=['object_container','bring_destination','end_pose'], output_keys=[],
                                        outcomes=['PREEMPTED',
                                                    'FAILED',
                                                    'FINISHED', 'shutdown'])
        ...
        with self:
            ...
            smach_rcprg.StateMachine.add('TakeOutObject', manipulation.TakeOutObject(sim_mode, conversation_interface, worker, marker_publisher),
            ...
            smach_rcprg.StateMachine.add('PutDownObject', manipulation.PutDownObject(sim_mode, conversation_interface, worker, marker_publisher),
